  ...
  <body class="home">
    ...
    <div class="columna izq">
      ...
      <ul class="izq__ul">
        ...
        <asp:UpdatePanel ID="uplnkPerfil" runat="server">
        <ContentTemplate>
            <li class="izq__li">
      ...
      <div class="izq__user">
        <img src="https://thumbs.dreamstime.com/b/foto-de-perfil-avatar-masculino-34443055.jpg" alt="User" class="user__img">
      ...
      <div class="columna centro">
        ...
        <div class="centro__pasando">
          <div class="pasando__up">
            <img class="pasando__img" src="https://thumbs.dreamstime.com/b/foto-de-perfil-avatar-masculino-34443055.jpg" alt="User">

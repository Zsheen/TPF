      ...
      <form id="form1" runat="server" enctype="multipart/form-data">
                              ...
                              <div class="pasando__inf">
                                  <ul class="pasando__ul">
                                      <li class="pasando__li">
                                          ...
                                          <input id="File1" runat="server" style="display: none;" type="file" accept="image/*,video/*" />
        ...
        <script>
                ...
                /*$(document).ready(function () {
                    ...
                    document.getElementById('btnTwittear').addEventListener('click', function () {                    

                        $.ajax({
                            type: "POST",
                            url: "Home.aspx/HacerPostStatic",
                            data: JSON.stringify({ texto: document.getElementById('textareaTwitt').value, NombreDelArchivo: document.getElementById('FileUpload1').files[0].name}),
                            //data: '{contenido: "' + document.getElementById('textareaTwitt').value + '" }',

                ...
                using (SqlCommand command = new SqlCommand("GetPostByFollowing", connection))
                {
                    ...
                    using (SqlDataReader reader = command.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            ...
                            {
                                CentroDTweets.InnerHtml += $@"<section id='{Convert.ToString(reader["PostID"])}' class='centro__tweet'>
                                                                ...
                                                                <div class='centro__col'>
                                                                    ...
                                                                    <div class='centro__row'>
                                                                        ...
                                                                        <img class='centro__img' src='{Contenido}' alt ='Archivo'>
                                                                    </div>
                                                                    <ul class='centro__ul'>
                                                                        <li class='centro__li'>
                            ...
                            {
                                centroTweets.InnerHtml += $@"<section id='{Convert.ToString(reader["PostID"])}' class='centro__tweet'>
                                                                <div class='centro__col'>
                                                                    <img class='centro__user' src='{URLDeSuFoto}' alt='Foto del usuario'>
                                                                </div>
                                                                <div class='centro__col'>
